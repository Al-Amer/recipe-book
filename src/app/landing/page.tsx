  ...
  return (
    <div className="justify-center ">
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-6  m-5 border-2 border-solid border-white-500">
            {arr.map((item) => (
                <Image key={item.id} src={item.Icon} alt={`Icon ${item.id}`} className="h-auto max-w-full rounded-full "/>
            )) }
        </div>
        </div>
        ...
        <div className="grid grid-cols-3 md:grid-cols-5 gap-6  m-5 border-2 border-solid border-white-500">
                ...
                <Image key={0} src={IconAmer} alt={`bild`} className="h-auto max-w-full rounded-full relative p-[5px] rounded-2xl animate-gradient 
                      bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 bg-[length:200%_200%]"/>
        </div>
        </div>
